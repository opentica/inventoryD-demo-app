...
then
	...
	APPD_OPTS="${APPD_OPTS} -Dappdynamics.agent.tierName=productservice"
	APPD_OPTS="${APPD_OPTS} -Dappdynamics.agent.nodeName=product-docker-node"
	...
	export LS_ACCESS_TOKEN=AL4U4cVLqCDzmPmwgiHq8wd4RRPunx1TYu22Pu22y/JHvov7YuyL0uJmsyKF1LXGZQNphiGz3pSg6HqBP28GYY5vxB8D/Os6Jb8JUVNI
        export LS_SERVICE_NAME=product
